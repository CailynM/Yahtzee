...
class MyTestCase(unittest.TestCase):
    ...
    def test_CheckRolls(self):
        #This will show you the results of your past rolls.
        self.game = Yahtzee()
        self.assertTrue(self.game.values == [])
        r1 = self.game.roll()
        self.assertTrue (self.game.values == [r1])
        r2 = self.game.roll()
        self.assertTrue (self.game.values == [r1,r2])
